...
DATA_SOURCE_A = os.path.join(XLSM_DIR, "9.1v1_fr.xlsx")                # ← 本批次 A（角色名 .xlsx_dataSource）
...
TEMPLATE_OUTPUT = os.path.join(XLSM_DIR, "pants_template_Adam.xlsm")  # ← 本批次产出模板
