...
DATA_SOURCE_A = os.path.join(XLSM_DIR, "9.4v1_de.xlsx")                # ← 本批次 A（角色名 .xlsx_dataSource）
...
TEMPLATE_OUTPUT = os.path.join(XLSM_DIR, "pants_herren_temp_init.xlsm")  # ← 本批次产出模板
