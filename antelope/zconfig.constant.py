...
ACTIVE_CATEGORY = "yass_fr_tracksuit"
...
DATA_SOURCE_A = os.path.join(XLSM_DIR, "9.2v1_fr.xlsx")                # ← 本批次 A（角色名 .xlsx_dataSource）
...
TEMPLATE_OUTPUT = os.path.join(XLSM_DIR, "tracksuit_template_Adam.xlsm")  # ← 本批次产出模板
